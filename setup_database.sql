...
-- Passo 1: Copie todo este conteúdo
-- Passo 2: Vá para o dashboard do Supabase: https://supabase.com/dashboard
-- Passo 3: Selecione seu projeto e vá para SQL Editor
-- Passo 4: Cole e execute este script
